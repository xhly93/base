package sharing.school.ctq.collect.ui.view;
...
/*                    if (!mScroller.isFinished()) {
    ...
    private OnCloseLister mOnClickListener;

    public void setOnCloseListener(OnCloseLister onClickListener) {
